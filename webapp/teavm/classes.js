...
"PENALTIES","TYPE","?20210306","UTF-8",", ","Unable to read layout data","Colemak-DH","Ergonomic","layout_full/colemak_dh.keyb","Colemak-DHk","layout_full/colemak_dhk.keyb","Colemak","Traditional","layout_full/colemak.keyb","Dvorak","layout_full/dvorak.keyb","Workman","layout_full/workman.keyb","Latynycja","layout_full/latynycja.keyb","Ukrainian++","layout_full/ukrainian_plus.keyb","Halmak","layout_full/halmak.keyb","Soul","Alternative","layout_full/soul.keyb","Niro","layout_full/niro.keyb","Asset","layout_full/asset.keyb",
...
"config/effort_matrix_ergodox_config.dat","Default English data","freq/en_books.freq","en_norvig","English Data from\n  Peter Norvig, norvig.com/mayzner.html","freq/en_norvig.freq","en_wikipedia","Data from the 100 most popular\n  Wikipedia articles","freq/en_wikipedia.freq","linux_src","Data from the Linux source code","freq/linux_src.freq","ua","Ukrainian Cyrillic data","freq/ua.freq","ua_lat_3","Latynycja MIX","freq/ua_lat_3.freq","es","Spanish data","freq/practical_cryptography/es_pc.freq",
"ua_lat_a","Latynycja A data","freq/ua_lat_a.freq","ua_lat_b","Latynycja B data","freq/ua_lat_b.freq","pl","Polish data","freq/practical_cryptography/pl_pc.freq","sv","Swedish data","freq/practical_cryptography/sv_pc.freq","Warning: Too many rows","Warning: letter "," is missing from layout. "," appears more than once on layout. ","Patter is null","\\Q","\\E","\\\\E\\Q","Is","In","<div style=\"display: table-row\">","<div style=\"display: table-cell\">","</div>","<div style=\"display: table-cell;padding-left:2ex\">",
